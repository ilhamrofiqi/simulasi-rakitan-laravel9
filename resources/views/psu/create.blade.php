...
<div class="container">
    <div class="header">
        <h3>Tambah Power Supply</h3>
    </div>
    <form action="/psu/store" method="POST">
        @csrf 
        <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Nama Power Supply</label>
            <input type="text" name="nama" class="form-control" placeholder="Power Supply" id="exampleFormControlInput1" >
        </div>
        <div class="mb-3">
